/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 4efa2d35df5d617f8b18d051d8a7284a)
// Runtime types generated with workerd@1.20260114.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		FEEDBACK_STORAGE: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* feedback-dashboard */;
		AI: Ai;
